    ...
    return {
        ...
        initStyleSwitcher: function () {
            ...
            var setColor = function (color, data_header) {
                ...
                jQuery('#style_color').attr("href", "../assets/css/css-rtl/theme-colors/" + color + ".css");
                if (data_header == 'light') {
                    jQuery('.logo img').attr("src", "../assets/img/logo_" + color + ".png");
                    jQuery('#logo-footer').attr("src", "../assets/img/logo_" + color + ".png");
                    jQuery('.navbar-brand img').attr("src", "../assets/img/logo_" + color + ".png");
                } else if (data_header == 'dark') {
                    jQuery('.logo img').attr("src", "../assets/img/logo_" + color + ".png");
                    jQuery('#logo-footer').attr("src", "../assets/img/logo_" + color + ".png");
                }
