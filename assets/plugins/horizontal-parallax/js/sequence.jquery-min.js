...
(function (e) {
    function t(t, n, r, i) {
        ...
        function g(t, n) {
            ...
            var r = t, i = e.isFunction(e.Deferred) ? e.Deferred() : 0, s = e.isFunction(i.notify), o = r.find("img").add(r.filter("img")), u = [], a = [], f = [];
            ...
            o.length ? o.bind("load.imagesLoaded error.imagesLoaded", function (e) {
                ...
                var r = n.src, i = e.data(n, "imagesLoaded");
                if (i && i.src === r) {
                    c(n, i.isBroken);
                    return
                }
        ...
        function y() {
            ...
            if (s.settings.hashTags) {
                ...
                if (s.currentHashTag === undefined || s.currentHashTag === "")s.nextFrameID = s.settings.startingFrameID; else {
            ...
            s.sequence.css({width: "100%", height: "100%", position: "relative"});
            s.sequence.children("li").css({width: "100%", height: "100%", position: "absolute", "z-index": 1});
            if (s.transitionsSupported)if (!s.settings.animateStartingFrameIn) {
            ...
            } else s.goTo(s.nextFrameID, 1); else {
                ...
                s.sequence.children(":not(li:nth-child(" + s.nextFrameID + "))").css({display: "none", opacity: 0});
                s.resetAutoPlay(!0, s.settings.autoPlayDelay)
            }
            ...
            if (s.settings.swipeNavigation && s.hasTouch) {
                ...
                function a(e) {
                    ...
                    if (o) {
                        var t = e.originalEvent.touches[0].pageX, n = e.originalEvent.touches[0].pageY, a = r - t, f = i - n;
        ...
        }, s.beforeNextFrameAnimatesIn = function () {
        }, s.afterNextFrameAnimatesIn = function () {
        }, s.beforeCurrentFrameAnimatesOut = function () {
        }, s.afterCurrentFrameAnimatesOut = function () {
        ...
        var l = s.settings.preloadTheseFrames.length, c = s.settings.preloadTheseImages.length;
        if (!s.settings.preloader || l === 0 && c === 0)e(window).bind("load", function () {
            ...
            var p = h(l), d = h(c, !0), v = e(p.concat(d)), m = v.length;
            g(v, f)
        }
    }
    ...
    t.prototype = {
        initCustomKeyEvent: function (e) {
            ...
            var n = this;
            e.css(n.prefixCSS(n.prefix, {"transition-duration": t, "transition-delay": t}))
            ...
            var t = this, e = e === undefined ? t.settings.autoPlayDelay : e;
            t.unpause();
            t.resetAutoPlay();
            ...
            if (n.settings.navigationSkip && n.active) {
                ...
                n.settings.fadeFrameWhenSkipped && n.nextFrame.stop().animate({opacity: 0}, n.settings.fadeFrameTime);
            ...
            if (!n.active || n.settings.navigationSkip) {
                ...
                if (n.transitionsSupported) {
                    ...
                    n.settings.moveActiveFrameToTop && n.nextFrame.css({"z-index": n.numberOfFrames});
                    ...
                    switch (n.settings.fallback.theme) {
                        case"fade":
                            n.sequence.children("li").css({position: "relative"});
                            n.beforeCurrentFrameAnimatesOut();
                            n.currentFrame = n.sequence.children("li:nth-child(" + n.currentFrameID + ")");
                            n.currentFrame.animate({opacity: 0}, n.settings.fallback.speed, function () {
                                n.currentFrame.css({display: "none", "z-index": "1"});
                        ...
                        default:
                            ...
                            n.currentFrame = n.sequence.children("li:nth-child(" + n.currentFrameID + ")");
                            n.beforeCurrentFrameAnimatesOut();
                            n.currentFrame.animate(i, n.settings.fallback.speed, function () {
                                n.afterCurrentFrameAnimatesOut()
                            });
                            n.beforeNextFrameAnimatesIn();
            ...
            if (r === "out")var s = function () {
                ...
                i.setHashTag();
                i.active = !1;
                if (!i.isHardPaused && !i.mouseover)if (!i.delayUnpause)i.unpause(!1); else {
                    i.delayUnpause = !1;
                    i.unpause()
                }
            };
    ...
    var n = {
        modernizr: function () {
            window.Modernizr = function (e, t, n) {
                ...
                var l = "2.6.1", c = {}, h = t.documentElement, p = "modernizr", d = t.createElement(p), v = d.style, m, g = {}.toString, y = "Webkit Moz O ms", b = y.split(" "), w = y.toLowerCase().split(" "), E = {svg: "http://www.w3.org/2000/svg"}, S = {}, x = {}, T = {}, N = [], C = N.slice, k, L = {}.hasOwnProperty, A;
